...
#define PIN_WINDOW_MAX_VALUE 59
...
typedef struct {
  Window *window;
  TextLayer *main_text, *sub_text, *sep_text;
  Layer *selection;
  GColor highlight_color;
  StatusBarLayer *status;
  PinWindowCallbacks callbacks;
  PIN pin;
  char field_buffs[PIN_WINDOW_NUM_CELLS][3];
...
*/
PinWindow* pin_window_create(PinWindowCallbacks pin_window_callbacks, PinWindowData pin_window_data);
/*
